...
# Rename "emodpy-hiv" to "API reference"
...
latex_documents = [
    (master_doc, 'emodpy-hiv-docs.tex', u'emodpy-hiv',
...
man_pages = [
    (master_doc, 'emodpy-hiv-docs', u'emodpy-hiv',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'emodpy-hiv-docs', u'emodpy-hiv',
     author, 'Institute for Disease Modeling', 'How to use emodpy for HIV simulations.',
     'Miscellaneous'),
]
