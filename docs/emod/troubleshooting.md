...
could signal an internal problem with the code. Please post on our [discussion board][discussions].
...
internal problem with the code. Please post on our [discussion board][discussions].
