...
| Report_Relationship_Start_Must_Have_IP_Key_Value | string | NA | NA | "" | A Key:Value pair that one of the partners must have for the relationship to be reported. Empty string means don't look at individual properties. For more information, see [model-properties](model-properties.md). |
| Report_Relationship_Start_Must_Have_Intervention | string | NA | NA | "" | The name of an intervention that the one of the partners must have in order for the relationship to be reported. Empty string means don't look at the interventions. For more information, see [parameter-campaign-individual-interventions](parameter-campaign-individual-interventions.md). |
