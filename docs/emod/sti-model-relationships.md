...
Human relationships are at the center of the EMOD STI model. Who individuals form sexual
...
The following section will describe how EMOD determines eligibility for relationship status, and
how relationships then form and proceed among eligible individuals. As a stochastic, agent-based
model, EMOD can track individuals and create dynamic relationship networks. The
...
(PFA). This algorithm has been described by [Bershteyn et al 2012][bershteyn-et-al-2012].
...
![The pair formation algorithm used to form relationships between individuals who seek them.](../images/hiv/PFA.png)
...
![Illustration of males and females forming queues.](../images/hiv/hiv-queues.png)
...
of sexual debut is randomly drawn for each individual from a *Weibull distribution*. Weibull
distributions are used often in EMOD and require two parameters: a shape parameter and a scale
parameter.
...
Currently, EMOD supports four different types of heterosexual relationships: transitory,
...
is governed by a *Weibull distribution*, which determines the duration that is assigned to a
...
*coital dilution*, i.e., a change in the frequency of coital acts as a result of having multiple
...
![The number of relationships consummated between different partners. Relationships in which both participants have one partner (red) have more coital acts than those in which one or both participants have multiple relationships (blue).](../images/hiv/coital-acts.png)
...
EMOD can be configured to allow for individuals to participate in multiple relationships
...
![An example time-course of an EMOD simulation, originally published in [Bershteyn et al. 2012, arXiv][bershteyn-2012-arxiv].](../images/hiv/time-course.png)
