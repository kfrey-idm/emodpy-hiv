...
| Stage | integer | The individual's disease stage. Possible values are:<br><br>* 0 = Uninfected<br>* 1 = Untreated acute HIV infection<br>* 2 = Untreated latent HIV infection<br>* 3 = Untreated late/AIDS stage<br>* 4 = On ART |
