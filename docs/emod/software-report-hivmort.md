...
| HIV_disease_state_just_prior_to_death | integer | Describes the disease state prior to the individual's death. Possible values are:<br><br>* 0 = Uninfected<br>* 1 = Untreated acute HIV infection<br>* 2 = Untreated latent HIV infection<br>* 3 = Untreated late/AIDS stage<br>* 4 = On ART |
