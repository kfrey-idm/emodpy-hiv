...
{{ read_csv('../csv/report-relationship-consummated.csv', keep_default_na=False) }}
...
| Node_ID | integer | The numerical identifier of the node as defined in the demographics. See [Demographics parameters](parameter-demographics.md) for details on configuring the NodeID values. |
