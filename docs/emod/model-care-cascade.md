...
*See example: [howto-carecascade.json](../json/howto-carecascade.json)*
...
EMOD sim types, the HIV model makes particular use of this feature. Living with HIV requires a
...
*See example: [hiv-accessibility.json](../json/hiv-accessibility.json)*
...
*See example: [hiv-carestep1.json](../json/hiv-carestep1.json)*
...
*See example: [hiv-carestep-continue.json](../json/hiv-carestep-continue.json)*
