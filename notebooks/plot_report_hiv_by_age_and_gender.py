...
def plot_age_based_data( df, num_runs, title, value_column ):
...
if __name__ == "__main__":
    ...
    report_filenames = get_report_filenames( "tutorial_2_results", "ReportHIVByAgeAndGender.csv" )
    df = create_dataframe_from_csv_reports( report_filenames )
    num_runs = len(report_filenames)
    plot_age_based_data( df, num_runs,  "Population (15-49) Over Time", " Population" )
    plot_age_based_data( df, num_runs,  "Number of People (15-49) on ART Over Time", " On_ART" )
    plot_age_based_data( df, num_runs,  "Number of Newly Infected People (15-49) (Incidence) Over Time", " Newly Infected" )
    plot_age_based_data( df, num_runs,  "Number of Infected People (15-49) (Prevalence) Over Time", " Infected" )
